...
namespace CcLibrary.AspNetCore.Services {
    public class PagingHelperService : IPagingHelperService{
        private readonly LinkGenerator linkGenerator;

        public PagingHelperService(LinkGenerator linkGenerator) {
            this.linkGenerator = linkGenerator;
        }
        public PagingMetadata GeneratePagingMetaData<T>(IPagedList<T> pagedData, PagingModel PagingModel, string controllerName, string methodName) {
        ...
        private string CreateUri(PagingModel PagingModel, ResourceUriType uriType, string controllerName, string methodName) {
